...
public class DigestUtilsTest {
    ...
    public void testBytesToHexString() throws Exception {
        ...
        final String str = DigestUtils.bytesToHexString(byteArray);
        assertThat(str).isEqualTo("007fff01ec22");
    }

    @Test
    public void testCalculateMD5() throws Exception {
        assertThat(DigestUtils.calculateMD5("xyz")).isEqualTo("d16fb36f0911f878998c136191af705e");
        assertThat(DigestUtils.calculateMD5("qwertyu")).isEqualTo("e86fdc2283aff4717103f2d44d0610f7");
        ...
        final String md5 = DigestUtils.calculateMD5(str);
